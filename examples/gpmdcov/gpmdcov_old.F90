...
contains
  ...
  subroutine gpmd_Part
    ...
    if(mdstep < 1)then 
      if(lt%verbose >= 1 .and. myRank == 1)call prg_get_mem("gpmdcov", "Before get_covgraph")
...
!       call bml_write_matrix(g_bml,"g_bml")
      ...
      if(lt%verbose >= 1 .and. myRank == 1)call prg_get_mem("gpmdcov", "After get_covgraph")  
    else 
...
!       call bml_zero_matrix(gsp2%bml_type,bml_element_real,kind(1.0),sy%nats,mdim,g_bml,lt%bml_dmode)  
      ...
      if(lt%verbose >= 1 .and. myRank == 1)call prg_get_mem("gpmdcov","Before graph2bml")          
      ...
      if(lt%verbose >= 1 .and. myRank == 1)call prg_get_mem("gpmdcov","After graph2bml")  
    ...
    if(lt%verbose >= 1 .and. myRank == 1)call prg_get_mem("gpmdcov","After get_subsystem")  
