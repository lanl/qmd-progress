...
program main
  ...
  real(dp) :: threshold, mu, beta, occErrLimit, nocc, error, tol
  integer :: k, method
  ...
  call prg_implicit_fermi(ham_bml, p_bml, nsteps, k, nocc,  mu, beta, method, osteps, occErrLimit, threshold, tol)
