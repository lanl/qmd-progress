...
contains
  ...
  case default
    ...
    stop "The file extension is not valid. Only xyz, dat and pdb formats are implemented"
...
subroutine write_system(system,filename,extension)
  ...
  case("lmp")
    ...
    !! For Lammps data.* input file.
    !! For more information see: http://lammps.sandia.gov/doc/2001/data_format.html
    io_name="data."//adjustl(trim(filename))//".lmp"
    call open_file(io_unit,io_name)
  ...
  case default
    ...
    stop "The file extension is not valid. Only xyz, dat, pdb or gen formats are implemented"
