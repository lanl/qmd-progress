...
module system_mod
  ...
  public :: graph2vector, vector2graph, sortadj, get_recip_vects
...
contains
  ...
  case default
    ...
    stop "The file estension is not valid. Only xyz, dat and pdb formats are implemented"
...
subroutine write_system(system,filename,extension)
  ...
  case("xyz")
    ...
    write(io_unit,*)nats
    write(io_unit,*)io_name, "Generated by the LATTE library"
    xyzformat = '(A2,3F10.5)'
    do i=1,nats           
  ...
  case("pdb")
    ...
    write(io_unit,'(A6,1X,A50)')"REMARK","Generated by LATTE library"
  ...
  case("dat")
    ...
    write(io_unit,*)"1.0","  Generated by the LATTE library"          
  ...
  case default
    ...
    stop "The file estension is not valid. Only xyz, dat, pdb or gen formats are implemented"
...
subroutine write_trajectory(system,iter,each,deltat,filename,extension)
  ...
  if(mod(iter,each).EQ.0.or.iter.EQ.0.or.iter.EQ.1)then
    ...
    case default
      ...
      stop "The file estension is not valid. Only pdb format is implemented"
...
subroutine translateandfoldtobox(coords,lattice_vectors,origin)
  ...
  !Get new origin. 
  origin(1) = -1.0d-5 ; origin(2) = -1.0d-5; origin(3) = -1.0d-5 
...
subroutine get_subsystem(sy,lsize,indices,sbsy,verbose)
  ...
  if(nsptmp.LT.sy%nsp)then 
    ...
    write(*,*)"See get_subsystem in system_latte_mod"  
!     stop
  endif
