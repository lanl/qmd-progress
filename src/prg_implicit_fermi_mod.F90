...
!       call bml_print_matrix("density matrix",p_bml,0,10,0,10)
  ...
  subroutine prg_test_density_matrix(ham_bml, p_bml, beta, mu, threshold)
    ...
    type(bml_matrix_t), intent(inout) :: p_bml
    real(dp), intent(in) ::  beta, mu, threshold
    character(20) :: bml_type
    integer :: N, i
    ...
    !call bml_print_matrix("occupation",occupation_bml,650,660,650,660)
    ...
    !call bml_print_matrix("eigenvectors transposed",aux1_bml,0,10,0,10)
