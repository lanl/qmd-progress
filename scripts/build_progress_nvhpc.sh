...
METIS_LIB="/pscratch/sd/m/mewall/packages/metis-5.1.0/install"
BML_LIB="/pscratch/sd/m/mewall/packages/qmd-progress/bml/install_nvhpc"
...
export PROGRESS_OFFLOAD=${PROGRESS_OFFLOAD:=yes}
...
export PROGRESS_NVTX=${PROGRESS_NVTX:=yes}
...
#export EXTRA_FCFLAGS=${EXTRA_FCFLAGS:="-DSANITY_CHECK"}
